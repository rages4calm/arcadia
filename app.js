/* Generated by tools/split_app.py -- application logic.
   Depends on the consts in data.js, which must load first. */
"use strict";
/* ═══════════ GAME MODEL ═══════════
...
/* Must match tools/export_items.py: the page for an item is keyed by its
   display name, so both sides have to derive the same slug from it. */
