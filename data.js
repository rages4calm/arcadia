/* Generated by tools/split_app.py -- game data only, no logic.
   Loaded before app.js by a plain <script src>, so these top-level
   consts land in the shared global lexical scope exactly as they did
   when both halves were one inline block.
   The big datasets are written one entry per line on purpose: as a
   single line git cannot merge two people adding different items. */
...
const GEAR_LIB = [
  ...
  {"slot":"Arms","name":"Celestial Yoku Staff","rarity":"legendary","lvl":39,"rolledSec":2,"rolls":[{"s":"will","p":1,"v":13},{"s":"focus","p":1,"v":13},{"s":"ferocity","p":1,"v":13},{"s":"link_count_pct","p":0,"v":-100.0},{"s":"link_count","p":0,"v":8.0}]},
  {"slot":"Arms","name":"Redeemed Celestial Katana","rarity":"legendary","lvl":39,"rolls":[{"s":"power","p":1,"v":13},{"s":"ferocity","p":1,"v":13},{"s":"focus","p":1,"v":13},{"s":"attack_speed","p":0,"v":8.8},{"s":"duration","p":0,"v":35.0}]},
  ...
  {"slot":"Chest","name":"Midnight Kimono","rarity":"epic","lvl":64,"rolledSec":3,"rolls":[{"s":"vitality","p":1,"v":48},{"s":"precision","p":1,"v":12},{"s":"will","p":1,"v":12}]},
...
const FLAVOUR={
 ...
 "weapon_t2_heavy_virelda_001":"A weighted tool for knocking scrap out of desert ruins, repurposed for combat. The scrap never complained this much.",
 ...
 "weapon_t2_greatsword_virelda_001":"A heavy, unpolished length of iron carried by Virelda's tribal guardians. Less a sword, more a verdict.",
 ...
 "weapon_t2_sword_virelda_001":"Standard kit for desert travellers. Clears brush, opens crates, and settles disagreements as a perfectly reliable sidearm.",
